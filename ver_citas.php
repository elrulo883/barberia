...
$isBarber = isset($_SESSION['rol']) && $_SESSION['rol'] == 'barbero';
    ...
    <div class="container">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                // Mostrar el botón de eliminar solo si el usuario no es un barbero
                if (!$isBarber) {
                    echo "<td>
        ...
        <p><a href="menu_recepcionista.php">Regresar al menú</a></p>
